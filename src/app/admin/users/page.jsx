    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Laporan demografis lengkap seluruh pengguna</p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-slate-300">
            <thead className="text-xs uppercase bg-slate-800/50 text-slate-400 border-b border-slate-700/50">
              <tr>
                <th className="px-6 py-4 font-semibold tracking-wider">Nama & Kontak</th>
                <th className="px-6 py-4 font-semibold tracking-wider">Usia</th>
                <th className="px-6 py-4 font-semibold tracking-wider">Asal Instansi</th>
                <th className="px-6 py-4 font-semibold tracking-wider">Pekerjaan</th>
                <th className="px-6 py-4 font-semibold tracking-wider">Jabatan</th>
                <th className="px-6 py-4 font-semibold tracking-wider">Durasi Pengisian</th>
              ...
              {loading ? (
                ...
                subs.map((s) => (
                  <tr key={s.id} className="hover:bg-slate-800/20 transition-colors">
                    ...
                    <td className="px-6 py-4 text-amber-400/80 font-mono text-xs">
